...
export function ContactPage() {
  return (
    <main className="page-main py-10 md:py-16">
      <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(320px,42%)] lg:gap-16">
        <div>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <a
                ...
                className="mt-2 inline-block break-all transition-colors hover:text-accent"
              >
                {siteConfig.email}
              </a>
            </div>
